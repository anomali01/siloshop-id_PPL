  ...
  const linkSections = [
    {
      title: "PRODUK",
      links: [
        { text: "Makanan Berat", path: "/kategori/makanan-berat", icon: null },
        { text: "Minuman", path: "/kategori/minuman", icon: null },
        { text: "Cemilan", path: "/kategori/cemilan", icon: null },
        { text: "Manisan", path: "/kategori/manisan", icon: null },
        { text: "Makanan Sehat", path: "/kategori/makanan-sehat", icon: null },
      ],
    },
    {
      title: "WEBSITE?",
      links: [
        ...
        { text: "Menjadi Plus Member", path: "/pricing", icon: null },
        { text: "Buat Toko Anda Sendiri", path: "/create-store", icon: null },
      ],
    },
    {
      title: "KONTAK",
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm">
              Selamat datang di SILOSHOP.ID, destinasi utama Anda untuk belanja
              makanan dan minuman di UISI. Dari makanan berat dan minuman hingga
              cemilan, dll. Kami hadirkan inovasi terbaik — semuanya di satu
              tempat.
            </p>
            <div className="flex items-center gap-3 mt-5">
              {socialIcons.map((item, i) => (
                <Link
                  href={item.link}
                  key={i}
                  className="flex items-center justify-center w-10 h-10 bg-slate-100 hover:scale-105 hover:border border-red-500 transition rounded-full"
                >
                  <item.icon />
                </Link>
              ))}
