...
const OurSpecs = () => {
  return (
    <div className="px-6 my-20 max-w-6xl mx-auto">
      <Title
        visibleButton={false}
        title="Spesifikasi Kami"
        description="Kami menawarkan layanan dan kenyamanan terbaik untuk memastikan pengalaman berbelanja Anda lancar, aman, dan sepenuhnya bebas repot."
      />
